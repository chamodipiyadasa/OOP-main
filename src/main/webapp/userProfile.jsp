...
<html lang="en">
  ...
  <body>
    ...
    <div style = "margin-top:65px;" class="update-profile">
        ...
        <form action="UserDeleteProfile" method="post" >
          
           <div class="flex">
              <div class="inputBox">
              	
                 <input type="hidden" name="userId" value="<% out.print(auth.getId());%>" class="box" readonly >
                 <span>Username :</span>
                 <input type="text" name="userName" value="<% out.print(auth.getName());%>" class="box">
                 <span>User Email :</span>
                 <input type="email" name="userEmail" value="<% out.print(auth.getEmail());%>" class="box">
               <!--   <span>update Admin pic :</span>
               <input type="file" name="adminImage" accept="image/jpg, image/jpeg, image/png" class="box">--> 
              </div>
              <div class="inputBox">
                 <input type="hidden" name="userAddres" value="">
                 <span>User Address :</span>
                 <input type="text" name="userEmail" placeholder="enter address" class="box" value="<% out.print(auth.getAddres());%>">
                 <span>User Contact :</span>
                 <input type="text" name="" placeholder="enter contact" class="box" value="<% out.print(auth.getContact());%>">    
              </div>
           </div>
           <a href="updateUserProfile.jsp" class="delete-btn">Update Profile</a>
           <a href="orders.jsp" class="delete-btn">Order History</a>
          
           <a href="home.jsp" class="delete-btn">go back</a>
